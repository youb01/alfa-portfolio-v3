    ...
    <AnimatePresence mode="wait">
      {isVisible && (
        <motion.nav
          ...
          className="hidden md:block fixed top-0 left-0 right-0 z-[1025] backdrop-blur-md bg-[rgb(var(--bg-primary)/0.8)] shadow-elevation-low border-b border-[rgb(var(--border-primary)/0.5)]"
        >
