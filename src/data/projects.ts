...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    description:
      "Designed and built a fully custom Shopify theme from scratch for a makeup table startup. Tailored every section, component and flow to the brand's identity — from product pages and collections to cart and checkout experience.",
    techStack: [
      "Shopify",
      "Liquid",
      "JavaScript",
  ...
  {
    id: "project-09",
    slug: "fysiotherapie-wennekers",
    number: "09",
    title: "Fysiotherapie Wennekers",
    subtitle: "Practice Website",
    description:
      "Designed and built a brand new website for a physiotherapy practice to modernise their digital presence. The site clearly presents the practice, practitioners and available treatments — improving online onboarding of new patients.",
    techStack: [
      "Next.js",
      "TypeScript",
      "Tailwind CSS",
